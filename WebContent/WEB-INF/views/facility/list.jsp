...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>教室名称:</label><input id="search-fac_name" class="wu-text" style="width:100px">
            <label>状态:</label>
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td><input id="add-fac_name" name="fac_name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写教室名称'"/></td>
            </tr>
              <tr>
                <td align="right">设施数量:</td>
                <td><input id="add-fac_count" name="fac_count" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写教室数量'"/></td>
            </tr>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td align="right">教室名称:</td>
                <td><input id="edit-fac_name" name="fac_name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写教室名称'"/></td>
            </tr>
              <tr>
                <td align="right">设施数量:</td>
                <td><input id="edit-fac_count" name="fac_count" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写教室数量'"/></td>
            </tr>
            <tr>
                <td align="right">开始时间:</td>
