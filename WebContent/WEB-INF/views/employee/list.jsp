...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>老师姓名:</label><input id="search-name" class="wu-text" style="width:100px">
            <label>性别:</label>
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td><input type="text" id="add-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写老师姓名'" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="add-salary" name="salary" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写老师工资'" /></td>
            </tr>
            <tr>
                <td align="right">电话:</td>
                 <td><input type="text" id="add-employee_phone" name="employee_phone" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写老师电话号码'" /></td>
            </tr>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td align="right">老师姓名:</td>
                <td><input type="text" id="edit-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写老师姓名'" /></td>
            </tr>
            <tr>
                <td align="right">工作类型:</td>
            ...
            <tr>
                <td align="right">工资:</td>
                <td><input type="text" id="edit-salary" name="salary" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写老师工资'" /></td>
            </tr>
            <tr>
                <td align="right">电话:</td>
                 <td><input type="text" id="edit-employee_phone" name="employee_phone" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写老师电话号码'" /></td>
            </tr>
            <tr>
                <td align="right">年龄:</td>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'name',title:'老师姓名',width:100,sortable:true},
