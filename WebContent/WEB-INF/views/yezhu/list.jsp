...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>学生姓名:</label><input id="search-yz_name" class="wu-text" style="width:100px">
            <label>性别:</label>
            ...
            <label>学生电话:</label><input id="search-yz_phone" class="wu-text" style="width:100px">
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td><input type="text" id="add-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学生用户名称'" /></td>
            </tr>
            <tr>
             ...
             <tr>
                ...
                <td><input type="text" id="add-yz_name" name="yz_name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学生姓名'" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="add-idCard" name="idCard" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学生身份证号码'" /></td>
            </tr>
            <tr>
                <td align="right">电话:</td>
                 <td><input type="text" id="add-yz_phone" name="yz_phone" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学生电话号码'" /></td>
            </tr>
            <tr>
                <td align="right">email:</td>
                 <td><input type="text" id="add-yz_email" name="yz_email" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学生email'" /></td>
            </tr>
        </table>
    </form>
</div>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td align="right">用户名称:</td>
                <td><input type="text" id="edit-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学生用户名称'" /></td>
            </tr>
     
          
             <tr>
                <td align="right">学生姓名:</td>
                <td><input type="text" id="edit-yz_name" name="yz_name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学生姓名'" /></td>
            </tr>
            <tr>
                <td align="right">性别:</td>
                <td>
            ...
            <tr>
                <td align="right">身份证号码:</td>
                <td><input type="text" id="edit-idCard" name="idCard" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学生身份证号码'" /></td>
            </tr>
            <tr>
                <td align="right">电话:</td>
                 <td><input type="text" id="edit-yz_phone" name="yz_phone" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学生电话号码'" /></td>
            </tr>
            <tr>
                <td align="right">email:</td>
                 <td><input type="text" id="edit-yz_email" name="yz_email" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学生email'" /></td>
            </tr>
        </table>
    </form>
</div>
...
<div id="edit_1-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit_1-form" method="post">
        ...
        <table>
             <tr>
                <td align="right">学生姓名:</td>
                <td><input type="text" id="edit_1-yz_name" readonly="readonly"  class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学生姓名'" /></td>
            </tr>
            <tr>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'yz_name',title:'学生姓名',width:100,sortable:true},
